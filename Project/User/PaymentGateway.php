...
ob_start();
	...
	if(isset($_POST["btn_pay"]))
	{
			...
			if($_POST["txt_bid"]!="")
			{
				$a = "update tbl_workpost set workpost_status='5' where workpost_id='".$_POST["txt_bid"]."'";
				if($conn->query($a))
				{
					?>
		<script>
		...
		<?php
			...
			else if($_POST["txt_pid"]!="")
			{
				$b = "update tbl_workrequest set workrequest_status='4' where workrequest_id='".$_POST["txt_pid"]."'";
				if($conn->query($b))
				{
					?>
		<script>
		...
		<form method="POST">
			...
			<div class="input-group">
				<div class="input-box">
                    ...
                    <input type="hidden" value="<?php echo $_GET["bid"];?>" name="txt_bid">
                    <input type="hidden" value="<?php echo $_GET["pid"];?>" name="txt_pid">
