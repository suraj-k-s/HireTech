...
include('Head.php');
    ...
    if(isset($_POST["btn_save"])) {
           ...
           header("Location:ViewLabourComplaint.php");
        }
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <?php
												$i = 0;
                                                $selQry = "select * from tbl_complaint c inner join tbl_complainttype t on t.complainttype_id=c.complainttype_id inner join tbl_labour u on c.labour_id = u.labour_id where complaint_status='0'";
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><a href="ViewLabourComplaint.php?up=<?php echo $data["complaint_id"] ?>" class="status_btn">Reply</a> </td>
                                            </tr>
                                            <?php                     
                                            }
                                            ?>
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <?php
												$i = 0;
                                                $selQry = "select * from tbl_complaint c inner join tbl_complainttype t on t.complainttype_id=c.complainttype_id inner join tbl_labour u on c.labour_id = u.labour_id where complaint_status='1'";
                                               $rs = $conn->query($selQry);
                                                while ($data = $rs->fetch_assoc()) {
